...
const ProbCipher = () => {
    ...
    function stringToRightLength(valueStr) {
        while (((valueStr.length * sizeOfChar) % sizeOfBlock) != 0) {
            valueStr += "*";
        }
        return valueStr;
    }
    ...
    function сutStringIntoBlocks(value) {
        ...
        for (let i = 0; i < blocksLength; i++) {
            blocks.push(stringToBinaryFormat(value.substring(i * lengthOfBlock, (i + 1) * lengthOfBlock)));
